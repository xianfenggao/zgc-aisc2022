...
import warnings
from thirdparty_pkgs.WarpAffine2GridSample.utils import get_transform, transform_keypoints, convert_image_np, show_image

warnings.filterwarnings("ignore")

"""1. Load image and landmarks"""
image = cv2.imread("thirdparty_pkgs/WarpAffine2GridSample/data/image.png")
image = cv2.cvtColor(image, cv2.COLOR_BGR2RGB)
image_height, image_width, _ = image.shape
keypoints = np.genfromtxt("thirdparty_pkgs/WarpAffine2GridSample/data/image.pts", skip_header=3, skip_footer=1)
