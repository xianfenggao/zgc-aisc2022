...
# from thirdparty_pkgs.Face_Robustness_Benchmark_Pytorch.thirdparty_pkgs.FaceModel import FaceModel
...
class ShuffleNet(nn.Module):
    ...
    def __init__(self, groups=3, in_channels=3, num_classes=1000, pooling='Linear'):
        ...
        if groups == 1:
            ...
            raise ValueError(
                """{} groups is not supported for
				   1x1 Grouped Convolutions""".format(20))
        ...
        self.layer5 = nn.AdaptiveAvgPool2d((7, 7))
