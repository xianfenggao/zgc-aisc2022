...
Net.load_state_dict(torch.load(
    "../../../ckpts/Face_Robustness_Benchmark_Pytorch/Backbone_ResNet_50_Epoch_36_Batch_204696_Time_2019-04-14-14-44_checkpoint.pth"))
Net.to(device).eval()
print(Net)
img = '../../../Tdata/source.png'
...
net = MobileNet(2)
net.load_state_dict(torch.load(
    "../../../ckpts/Face_Robustness_Benchmark_Pytorch/Backbone_Mobilenet_Epoch_125_Batch_710750_Time_2019-04-14-18-15_checkpoint.pth"))
net.to(device).eval()
print(net)
print(net(img_cropped).shape)
...
net.load_state_dict(torch.load(
    "../../../ckpts/Face_Robustness_Benchmark_Pytorch/Backbone_ShuffleNet_Epoch_124_Batch_1410128_Time_2019-05-05-02-33_checkpoint.pth"))
net.to(device).eval()
print(net)
print(net(img_cropped).shape)
