...
import numpy as np
from thirdparty_pkgs.Retinaface_Pytorch.data import cfg_mnet, cfg_re50
...
from thirdparty_pkgs.Retinaface_Pytorch.utils.timer import Timer

parser = argparse.ArgumentParser(description='Retinaface')
parser.add_argument('-m', '--trained_model', default='./weights/Resnet50_Final.pth',
                    type=str, help='Trained state_dict file data_path to open')
...
parser.add_argument('--dataset_folder', default='./Tdata/widerface/val/images/', type=str, help='dataset data_path')
