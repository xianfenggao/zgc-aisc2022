'''
adapted from the source code of https://arxiv.org/abs/2204.00964
...
def build_head(head_type,
    ...
    if head_type == 'adaface':
        head = AdaFace(in_features=embedding_size,
...
class AdaFace(Module):
    ...
    def forward(self, embbedings, label):
        ...
        return scaled_cosine_m, self.s * _cosine
