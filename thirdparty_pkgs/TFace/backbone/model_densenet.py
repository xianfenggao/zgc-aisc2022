...
def densenet201(input_size, **kwargs):
    model = densenet(input_size, embedding_size=512, blocks=201, **kwargs)
    return model


def densenet169(input_size, **kwargs):
    model = densenet(input_size, embedding_size=512, blocks=169, **kwargs)
    return model


def densenet121(input_size, **kwargs):
    model = densenet(input_size, embedding_size=512, blocks=121, **kwargs)
    return model
