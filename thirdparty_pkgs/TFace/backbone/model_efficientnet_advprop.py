...
class EfficientNet_ap(nn.Module):
    """
    ...
    def __init__(self,
                 ...
                 in_size=(112, 112),
                 embedding_size=512):
        super(EfficientNet_ap, self).__init__()
...
def EfficientNetB5(input_size):
    """  Constructs an EfficientNet-B0 model.
    """
    return efficientnet(input_size, embedding_size=512, version='b5')


def EfficientNetB8(input_size):
    """  Constructs an EfficientNet-B0 model.
    """
    return efficientnet(input_size, embedding_size=512, version='b8')
