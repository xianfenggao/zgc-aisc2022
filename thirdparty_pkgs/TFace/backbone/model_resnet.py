...
from thirdparty_pkgs.TFace.backbone.common import initialize_weights
...
class ResNet(Module):
    ...
    def __init__(self, input_size, block, layers, zero_init_residual=True):
        ...
        self.AdaptiveAvgPool2d = nn.AdaptiveAvgPool2d((4, 4)) if input_size[0] == 112 else nn.AdaptiveAvgPool2d((7, 7))
