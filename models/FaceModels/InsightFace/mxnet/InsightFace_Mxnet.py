...
from thirdparty_pkgs.mxnet_insightface_bk import kit_MXNET_LResNet34E_IR, kit_MXNET_LResNet50E_IR, \
    kit_MXNET_LResNet100E_IR
from models.FaceModels.Base import BaseFaceModel


class MXNET_LResNet34E_IR(BaseFaceModel):
    ...
    def __init__(self,
        ...
        super(MXNET_LResNet34E_IR, self).__init__(input_shape, ckpt, device, mean, std)
        self.backbone = kit_MXNET_LResNet34E_IR.Kit_LResNet34E_IR(self.ckpt)
        self.backbone.eval().to(device)


class MXNET_LResNet50E_IR(BaseFaceModel):
    ...
    def __init__(self, device='cuda',
        ...
        super(MXNET_LResNet50E_IR, self).__init__(input_shape, ckpt, device, mean, std)
        self.backbone = kit_MXNET_LResNet50E_IR.Kit_LResNet50E_IR(self.ckpt)
        # self.backbone.load_state_dict(torch.load(ckpt))
        self.backbone.eval().to(device)


class MXNET_LResNet100E_IR(BaseFaceModel):
    ...
    def __init__(self, device='cuda',
        ...
        super(MXNET_LResNet100E_IR, self).__init__(input_shape, ckpt, device, mean, std)
